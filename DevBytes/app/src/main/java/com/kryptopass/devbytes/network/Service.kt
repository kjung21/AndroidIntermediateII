package com.kryptopass.devbytes.network
...
// If you add more services, split this to multiple files
// and make sure to share the retrofit object between services.
 ...
 * Call like `Network.devbytes.getPlaylist()`
 */
object Network {
